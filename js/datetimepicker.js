...
/*                '<div class="dtp-buttons">' +
                ...
                '<button class="dtp-btn-ok btn btn-info"><i class="fa fa-check-square-o"></i> ' + this.params.okText + '</button>' +
                '<button class="dtp-btn-cancel btn btn-default"><i class="fa fa-times-circle-o"></i> ' + this.params.cancelText + '</button>' +
                '<div class="clearfix"></div>' +
                '</div>' +*/
