		...
		l.VERSION = "1.12.4",
			...
			init: function() {
				...
				this.$element.addClass("bs-select-hidden"),
					...
					void 0 !== c && (this.$button.attr("data-id", c),
			...
			createLi: function() {
				...
				return l.each(function(b) {
					...
					if (g++,
						...
						var k, m = this.className || "", n = j(this.style.cssText), o = f.data("content") ? f.data("content") : f.html(), p = f.data("tokens") ? f.data("tokens") : null , q = void 0 !== f.data("subtext") ? '<small class="text-muted">' + f.data("subtext") + "</small>" : "", r = void 0 !== f.data("icon") ? '<span class="' + c.options.iconBase + " " + f.data("icon") + '"></span> ' : "", s = f.parent(), t = "OPTGROUP" === s[0].tagName, u = t && s[0].disabled, v = this.disabled || u;
						...
						if (f.data("content") || (o = r + '<span class="text">' + o + q + "</span>"),
							...
							if (0 === f.index()) {
								...
								y = (s.data("icon") ? '<span class="' + c.options.iconBase + " " + s.data("icon") + '"></span> ' : "") + '<span class="text">' + j(y) + z + "</span>",
									0 !== b && d.length > 0 && (g++,
				...
				c.data("spaceSelect", !1),
					...
					if (b.options.liveSearch || b.multiple) {
						if (!b.multiple) {
							...
							if ("number" != typeof a || !1 === b.options.size)
								return;
			...
			keydown: function(b) {
				...
				if (i.options.liveSearch && /(^9$|27)/.test(b.keyCode.toString(10)) && f && (b.preventDefault(),
					...
					d = i.options.liveSearch ? c.index(c.filter(".active")) : c.index(c.find("a").filter(":focus").parent()),
						...
						38 == b.keyCode ? (!i.options.liveSearch && d != e || -1 == d || d--,
